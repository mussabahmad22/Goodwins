    ...
    <table class="table table-report table-report--bordered display datatable w-full">
        ...
        <tbody>
            ...
            <tr>
                <th scope="row">{{ $i }}</th>
                <td>
                    <img src="{{asset('public/storage/'. $win->profile_img)}}" width="50" height="50">
                </td>
                <td>
                    <?= $win->username?>
                </td>
                ...
                <td>
                    <button style="border:none;" type="button" value="{{$win->id}}" class="deletebtn btn"><a
...
<div class="modal" id="delete-modal-preview">
    <div class="modal__content">
        ...
        <div class="px-5 pb-8 text-center">
            <form type="submit" action="{{route('delete_winner')}}" method="post">
                @csrf
                @method('DELETE')
                <input type="hidden" name="delete_winner_id" id="deleting_id"></input>
